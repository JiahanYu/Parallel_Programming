/* compile:
 * mpicc MS_MPI_static.c -o MS_MPI_static -L /opt/X11/lib -l X11
 * execute:
 * $mpiexec -np <numOfProcesses> ./MS_MPI_static <anynumber> <xmin> <xmax> <ymin> <ymax> <XResn> <YResn> <enable/disable>
 * e.g. $mpiexec -np 4 ./MS_MPI_static 4 -2 2 -2 2 400 400 enable
 */
#include <X11/Xlib.h>
#include <stdio.h>
#include <stdlib.h>
...
int main(int argc, char *argv[])
{
	...
	if(rank == 0){
	    ...
	    FILE *log_file_p;
	    char file_name[100];
	    sprintf(file_name, "MPI_static_%d_processes_execution_time.txt", size);
